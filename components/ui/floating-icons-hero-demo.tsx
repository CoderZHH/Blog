...
const IconApple = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconGitHub = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconNotion = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconVercel = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconX = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
export default function FloatingIconsHeroDemo() {
  return (
    <FloatingIconsHero
      ...
      subtitle="Obsidian is where thoughts begin. Around it, the rest of the stack keeps research, design, code, and shipping moving in sync."
      ctaText="Start a Conversation"
      ctaHref="#contact"
      icons={demoIcons}
      className="bg-[radial-gradient(circle_at_top,rgba(228,237,245,0.9),rgba(255,255,255,1)_50%,rgba(245,248,251,1)_100%)]"
    />
  );
}
